...
import static ua.pirateparty.games.tanks.server.conf.Constants.DEFAULT_TANK_ID;
...
public class PlayerDao implements IPlayerDao{
    ...
    private final String TABLE = FACTORY.getTables().get("players");
    ...
    public Player create(Player player) {
        ...
        try{
            ...
            if (rs.next()){
                ...
                IStatisticDao statisticDao = new StatisticDao();
    ...
    @Override
    public boolean read(String name, char[] passHash) {
        StringBuilder query = new StringBuilder();
        query.append(SELECT_ALL_FROM).append(TABLE).append(WHERE);
        query.append("name=").append(name).append(AND);
        query.append("secret=").append(passHash).append(SEMICOLON);
